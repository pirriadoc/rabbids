...
## no se incluye, es decir sería lo mismo que poner in range (3,meses+1)
				...
				correcto = True
## Excepción si el numero de meses es < 0
		except UnboundLocalError:
			res = 'El numero de meses debe ser mayor que 0, gracias'
			correcto = True
## Excepción si el numero de meses no es de tipo numérico
		except TypeError:
			res = 'El numero de meses debe ser de tipo int, gracias'
			correcto = True
	return res
